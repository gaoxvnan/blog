...
import com.gaoxvnan.blog.utils.JWTUtils;
...
public class LoginServiceImpl implements LoginService {
    ...
    private static final String salt = "awang!@#";
    ...
    public Result login(LoginParam loginParam) {
         ...
         * 5.token放入redis当中，resid  token：user信息，设置过期时间
